...
export class RegistroService {
  ...
  public async getRegistrosBusquedaDocente(
    ...
    try {
      return await this.registroRepository.getRegistrosBusquedaDocente(
        registroDTO,
      );
    } catch (error) {
      console.error(error);
  ...
  public async getCantidad_de_registros_en_un_mes(
    ...
    try {
      return await this.registroRepository.getCantidad_de_registros_en_un_mes(
        idusuario,
      );
    } catch (error) {
      console.error(error);
      throw new Error("Error consulta getCantidad_de_registros_en_un_mes");
    }
  }
